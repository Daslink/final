...
/**
 * Test for transaction T001T00401COTransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/T001T00401COTest.xml" })
public class T001T00401COTransactionTest {
	private static final Logger LOGGER = LoggerFactory.getLogger(T001T00401COTransactionTest.class);
	
	@Autowired
	private T001T00401COTransaction transaction;
